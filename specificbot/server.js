...
async function runChat(userInput) {
  ...
  const chat = model.startChat({
    ...
    history: [
      ...
      {
        role: "model",
        parts: [{ text: "I am great. I am here to help you learn one of thes 4 languages in Kenya: Kikuyu, Kalenjin, Somali and Luo."}],
      },
    ],
  });
